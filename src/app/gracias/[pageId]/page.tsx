    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 pt-20">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold mb-2">Método de pago rechazado</h1>
          <p className="text-gray-500 mb-6">Tu banco o tarjeta no pudo procesar el pago. Por favor, intentá con otro método de pago.</p>
          <a
